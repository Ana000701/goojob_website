...
export default function Footer() {
  return (
    <div className="max-w-full md:w-[90%] mx-auto container px-4">
      <Link
        href="#"
      ...
      >
        ...
        <Image src="arrow_upward.svg" alt="arrow_upward_icon" width={24} height={24} />
      </Link>
      {/* Social List & Slogan */}
      <div className="flex flex-col md:flex-row-reverse md:justify-between gap-6 mb-9">
        ...
        <ul className="flex items-center gap-5">
          ...
          <li>
            <Link href="#">
              <Image src="youtube.svg" alt="youtube-icon" width={24} height={24} />
            </Link>
          </li>
        </ul>
      </div>
      {/* Company Info & Navbar */}
      <div className="flex justify-between pb-5 md:pt-24 lg:pt-48 lg:pb-36 border-b mb-5">
        <div>
          <p className="text-primary title-base font-bold tracking-wider mb-4">GooJob 智慧管理</p>
          <div className="text-brand">
            <p className="p-base font-bold tracking-widest mb-2">鼎盛佳科技股份有限公司</p>
            <ul className="flex flex-col gap-1">
              <li>
                <span className="p-xs font-bold tracking-[0.1em] mr-2">TEL</span>
                <Link href="tel:+886075588057" className="p-xs font-medium tracking-wider">
                  (07)5588 - 057
                </Link>
              </li>
              <li>
                <span className="p-xs font-bold tracking-[0.1em] mr-2">E-MAIL</span>
                <Link
                  href="mailto:service@goojob.com.tw"
                  className="p-xs font-medium tracking-wider"
                >
                  service@goojob.com.tw
                </Link>
              </li>
              <li>
                <span className="p-xs font-bold tracking-[0.1em] mr-2">TAX ID</span>
                <span className="p-xs font-medium tracking-wider">90577449</span>
              </li>
              <li>
                <span className="p-xs font-bold tracking-[0.1em] mr-2">ADDRESS</span>
                <span className="p-xs font-medium tracking-wider">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2.5">
        <div>
          <p className="p-xs tracking-wider">
            Copyright © {new Date().getFullYear()} 鼎盛佳科技股份有限公司 著作權所有
          </p>
        </div>
